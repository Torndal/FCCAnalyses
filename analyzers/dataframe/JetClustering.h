...
struct clustering {
  ...
  std::vector<std::pair<ROOT::VecOps::RVec<int>, ROOT::VecOps::RVec<fastjet::PseudoJet>>> operator() (ROOT::VecOps::RVec<float> p_x, ROOT::VecOps::RVec<float> p_y, ROOT::VecOps::RVec<float> p_z, ROOT::VecOps::RVec<float> E);
};
